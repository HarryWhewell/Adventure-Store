...
(function(){
    ...
    function ApparelService(CrudService){
        ...
        apparelService.createApparel = function(data, success, error){
            return CrudService.postRequest('/localhost:8080/api/apparel/', data, success, error);
        };

        // get apparel by id
        apparelService.getApparelById = function(id, success, error){
            return CrudService.getRequest('/localhost:8080/api/apparel/' + id, success, error);
        };

        // update apparel by id
        apparelService.updateApparelById = function(id, data, success, error){
            return CrudService.putRequest('/localhost:8080/api/apparel/' + id, data, success, error);
        };

        // delete apparel by id
        apparelService.deleteApparelById = function(id, success, error){
            return CrudService.deleteRequest('/localhost:8080/api/apparel/' + id, success, error);
        };
